 ...
 *  - object definition of how to construct the class
 * @param {array<string>|string} classes.values
 *  - passed in class names to match
 * @param {array<string>} [classes.dictionary=[]]
 *  - set dictionary to match values against.
 * if a dictionary is not passed, all classes.values will be returned
 * @param {function} [classes.template=(val) => val]
 *  - template function which will receive the value and return ta parsed string.
 *
